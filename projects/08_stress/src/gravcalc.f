c
      subroutine gravcalc(kx,ky,H,Te,rhoc,rhom,aobs,fk,zs,grval)
c
c  input 
...
c       
      gsurf=Gcns*fk*rhoc*exp(-beta*(aobs-zs))
c      gmoho=Gcns*fk*trans*(rhom-rhoc)*exp(-beta*(aobs-zs-H))
      gmoho=Gcns*fk*rhoc*exp(-beta*(aobs-zs-H))*trans
c
